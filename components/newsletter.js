    ...
    <div className="bg-gradient-to-r from-blue-500 to-pink-400 md:bg-gradient-to-r">
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:py-16 lg:px-8">
        <div className="lg:w-0 lg:flex-1">
          ...
          <p className="mt-3 max-w-3xl text-lg leading-6 text-zinc-100">{newsletter.description[router.locale]}</p>
        </div>
        <div className="mt-8 lg:mt-0 lg:ml-8">
          <form onSubmit={subscribe} className="sm:flex">
            <label htmlFor="email-input" className="sr-only">
              {newsletter.form.email.label[router.locale]}
            </label>
            <input
              ref={emailRef}
              id="email-input"
              ...
              placeholder={newsletter.form.email.placeholder[router.locale]}
              required
            />
            <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button
                ...
                {newsletter.form.submit[router.locale]}
              </button>
            </div>
          </form>
