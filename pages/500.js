  ...
  return (
    <div
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 text-center sm:px-6 sm:py-24 lg:px-8 lg:py-48">
        ...
        <h1 className="mt-2 text-4xl font-extrabold tracking-tight text-white sm:text-5xl">{`Server error.`}</h1>
        <p className="mt-2 text-lg font-medium text-black text-opacity-50">
          {`There is currently a problem with this page`}
        </p>
        <div className="mt-6">
          <Link href="/">
